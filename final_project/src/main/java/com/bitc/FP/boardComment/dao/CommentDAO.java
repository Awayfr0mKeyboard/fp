package com.bitc.FP.boardComment.dao;
...
public interface CommentDAO {
	...
	@Insert("INSERT INTO b_comment(b_num, email, c_content) "
			+ "VALUES(#{b_num}, #{email}, #{c_content})")
	...
	@Update("UPDATE b_comment SET email = #{email}, "
